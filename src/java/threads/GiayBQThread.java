 ...
 * @author MinhTran
 */
public class GiayBQThread extends BaseThread implements Runnable {

    private ServletContext context;
    private final String configPath = "WEB-INF/targets/giaybq.xml";

    public GiayBQThread(ServletContext context) {
            ...
            try {
                for (int i = 0; i < nodeList.getLength(); i++) {
                    ...
                    if (node.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        Thread thread = new Thread(new GiayBQCrawler(context, url, sex, categoryId));
                        thread.start();
                    }
                }
